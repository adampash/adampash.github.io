...
I'm pretty sure that should get you up and running, but in case I missed a step, feel free to send me an email or a [pull request](https://github.com/adampash/adampash.github.io).
